...
export class ClaudeBackend {
    ...
    parseResponse(stdout, durationMs, exitCode) {
        ...
        if (resultJson === undefined) {
            throw new AIServiceError('PARSE_ERROR', `No JSON result object found in Claude CLI output. Raw output (first 200 chars): ${stdout.slice(0, 200)}`);
        }
        let parsed;
        try {
