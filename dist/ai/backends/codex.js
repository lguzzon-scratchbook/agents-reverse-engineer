 ...
 * system-prompt flag.
 */
function composePromptWithSystem(options) {
 ...
 */
function collectText(value, out, shouldSkipObject) {
...
function shouldSkipTextObject(obj) {
 ...
 */
function extractUsageFromTurnCompleted(usage) {
...
export class CodexBackend {
    ...
    parseResponse(stdout, durationMs, exitCode) {
        ...
        throw new AIServiceError('PARSE_ERROR', 'Failed to extract assistant text from Codex CLI output');
    }
